...
build: build-raspbian
	
build-raspbian: pibuilder.patch first_run.patch
	docker build --build-arg RASPBIAN_LITE_VERSION=$(raspbian-lite-version) -t gencore/auto-pi-bakery:$(docker-tag) .
	docker tag gencore/auto-pi-bakery:$(docker-tag) gencore/auto-pi-bakery:latest
...
publish:
	...
	docker push gencore/auto-pi-bakery:$(docker-tag)
	docker push gencore/auto-pi-bakery:latest
